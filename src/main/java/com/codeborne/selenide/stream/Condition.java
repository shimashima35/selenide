package com.codeborne.selenide.stream;
 ...
 */
public abstract class Condition implements Predicate<WebElement>, com.google.common.base.Predicate<WebElement> {
  /**
  ...
  public static Condition text(final String text) {
    return new com.codeborne.selenide.stream.conditions.Text(text);
  }
